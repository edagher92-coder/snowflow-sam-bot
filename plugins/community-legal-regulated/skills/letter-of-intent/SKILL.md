...
> **Disclaimer:** This skill provides general informational guidance only. It is not a substitute for advice from a licensed professional (lawyer, accountant, tax agent, doctor, or other qualified advisor). Always confirm anything consequential with a qualified professional before acting on it.
